...
| S-28 | done 2026-09-09 (PR #TBD) | Copy only. The ask named a second model; left out because a Claude Code plugin cannot run on it and the README must not claim what cannot be verified (memo O-20). |
